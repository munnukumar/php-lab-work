...
<html>
    ...
    <title>Party menu</title>
        ...
        <style>
            *, *::before, *::after{
            ...
            th{
                border: 1px solid #38ebba;
            }
            td{
                border-left: 1px solid #38ebba;
    ...
    <body>
        <header>
            <h1><span class ="white">party</span><span class = "black">maker</span></h1>
            <div class = "about">we organise parties that you will remember!!!</div>
        </header>
        <h1 class = "sub-heading">Birthday Party</h1>
        <form method = "post">
            <table>
                <tr>
                    <th>S.NO.</th>
